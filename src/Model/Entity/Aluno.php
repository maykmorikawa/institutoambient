...
class Aluno extends Entity
{
    ...
    protected array $_accessible = [
        ...
        'religiao' => true,
        'naturalidade' => true,
        'outra_naturalidade' => true,
        'nacionalidade' => true,
        'outra_nacionalidade' => true,
        'etnia' => true,
        'programas_sociais' => true,
        'outra_programas_sociais' => true,
        'valor_do_beneficio' => true,
        'deficiencia' => true,
        'outra_deficiencia' => true,
        'encaminhado_instituicao' => true,
        'outra_instituicao_encaminhado' => true,
        'autorizo_imagem' => true,
        'compromisso_participacao' => true,
    ];
}
