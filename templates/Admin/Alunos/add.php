...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">
        <i class="fas fa-user-plus me-2 text-primary"></i><?= __('Matricular Novo Cidadão (Aluno)') ?>
    </h1>
    <?= $this->Html->link('<i class="fas fa-arrow-left fa-sm text-white-50 me-1"></i> Voltar ao Diretório', ['action' => 'index'], ['class' => 'btn btn-sm btn-secondary shadow-sm', 'escape' => false]) ?>
</div>
            ...
            <div class="card-body p-0">
                <div class="nav flex-column nav-pills" id="aluno-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link rounded-0 p-3 border-bottom" id="pills-endereco-tab" data-toggle="pill" href="#pills-endereco" role="tab" aria-controls="pills-endereco" aria-selected="false">
                        ...
                        <div class="small text-muted mt-1 " style="margin-left:28px;">Endereço de moradia oficial.</div>
                    </a>
                    <a class="nav-link rounded-0 p-3" id="pills-escolaridade-tab" data-toggle="pill" href="#pills-escolaridade" role="tab" aria-controls="pills-escolaridade" aria-selected="false">
                        ...
                        <div class="small text-muted mt-1 " style="margin-left:28px;">Escola e nível que atua hoje.</div>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-body p-5">
                    ...
                    <div class="tab-pane fade show active" id="pills-dados" role="tabpanel" aria-labelledby="pills-dados-tab">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <?= $this->Form->control('email', ['type' => 'email', 'class' => 'form-control', 'label' => false, 'placeholder' => 'E-mail real']) ?>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="small font-weight-bold text-dark">Telefone / WhatsApp</label>
                                <?= $this->Form->control('telefone', ['class' => 'form-control mascara-telefone border-left-success', 'label' => false, 'placeholder' => '(  ) ____-____']) ?>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4 mb-3">
                                ...
                                <?= $this->Form->control('cpf', ['class' => 'form-control mascara-cpf', 'label' => false, 'placeholder' => '___.___.___-__']) ?>
                            </div>
                            <div class="col-md-4 mb-3">
                    ...
                    <div class="tab-pane fade" id="pills-endereco" role="tabpanel" aria-labelledby="pills-endereco-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <?= $this->Form->control('enderecos.0.complemento', ['class' => 'form-control text-muted', 'label' => false, 'placeholder' => 'Ex: Ap 34 Bloco B']) ?>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="pills-escolaridade" role="tabpanel" aria-labelledby="pills-escolaridade-tab">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-8 mb-3">
                                ...
                                <?= $this->Form->control('escolaridades.0.instituicao', ['class' => 'form-control', 'label' => false, 'placeholder' => 'Escola ou Nome da Facul']) ?>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="small font-weight-bold text-dark">Ano da Graduação / Formatura</label>
                                <?= $this->Form->control('escolaridades.0.ano_conclusao', ['class' => 'form-control bg-light', 'label' => false, 'placeholder' => 'YYYY']) ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <?= $this->Form->control('escolaridades.0.curso', ['class' => 'form-control text-primary font-weight-bold', 'label' => false, 'placeholder' => 'Engenharia, Ti, Letras...']) ?>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="small font-weight-bold text-dark">Ano Cursado / Série Escolar</label>
                                <?= $this->Form->control('escolaridades.0.serie', ['class' => 'form-control text-primary font-weight-bold', 'label' => false, 'placeholder' => '5º Ano, 3º Colegial...']) ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end align-items-center">
                    <span class="text-muted small me-4"><i class="fas fa-exclamation-triangle text-warning me-1"></i> Assegure-se de salvar antes de trocar de aba.</span>
                    <?= $this->Form->button('<i class="fas fa-save me-2"></i> ' . __('Ingressar Base de Dados Original'), ['class' => 'btn btn-primary btn-lg shadow-sm px-5 ml-4', 'escapeTitle' => false]) ?>
                </div>
...
<!-- JQuery e Mask plugin para inputs (Como o SB Admin 2 usa JQuery puro do Bootstrap 4, é seguro injetar máscara assim) -->
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        if (typeof $ !== 'undefined' && $.fn.mask) {
            ...
            // Mascara de telefone flexivel (8 e 9 digitos)
    ...
    // SBAdmin2 Bootstap 4 usa "data-toggle='pill'". Apenas garante comportamento.
