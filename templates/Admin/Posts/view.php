    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <table class="table table-striped">
                ...
                <tr>
                    <th><?= __('Categoria') ?></th>
                    <td><?= $post->hasValue('category') ? $this->Html->link($post->category->name, ['controller' => 'Categories', 'action' => 'view', $post->category->id]) : '-' ?>
                    </td>
                </tr>
                <tr>
                    <th><?= __('Autor') ?></th>
                    <td><?= $post->hasValue('user') ? $this->Html->link($post->user->name, ['controller' => 'Users', 'action' => 'view', $post->user->id]) : '-' ?>
                    </td>
                </tr>
                <tr>
                    <th><?= __('Slug') ?></th>
                        ...
                        <?php if ($featured): ?>
                            <div class="featured-image mb-4">
                                <img src="<?= $this->Url->build('/img/uploads/' . $featured->filename) ?>"
                                    alt="Imagem destaque" class="img-fluid">
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="gallery">
                            <?php foreach ($post->post_images as $img): ?>
                                <?php if (!$img->is_featured): ?>
                                    <img src="<?= $this->Url->build('/img/uploads/' . $img->filename) ?>" alt="Imagem"
