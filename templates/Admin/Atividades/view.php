        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    <tr>
                        <th><?= __('Projeto') ?></th>
                        <td><?= $atividade->hasValue('projeto') ? $this->Html->link($atividade->projeto->name, ['controller' => 'Projetos', 'action' => 'view', $atividade->projeto->id]) : '<span class="badge bg-secondary text-white">' . __('Sem Projeto') . '</span>' ?></td>
                    </tr>
                    <tr>
                        <th><?= __('Nome') ?></th>
                    ...
                    <tr>
                        <th><?= __('Usuário') ?></th>
                        <td><?= $atividade->hasValue('user') ? $this->Html->link($atividade->user->name, ['controller' => 'Users', 'action' => 'view', $atividade->user->id]) : '<span class="badge bg-secondary text-white">' . __('Sem Usuário') . '</span>' ?></td>
                    </tr>
                    <tr>
                        <th><?= __('Slug') ?></th>
