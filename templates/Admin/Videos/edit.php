...
<div class="videos edit content">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><?= __('Editar Vídeo') ?></h1>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body text-center py-5">
                    <?php if ($video->background_image): ?>
                        <div class="mb-4">
                            <label class="small font-weight-bold text-uppercase d-block mb-2">Capa Atual</label>
                            <img src="<?= $this->Url->build('/img/uploads/' . $video->background_image) ?>" 
                                 class="img-fluid rounded shadow-sm" style="max-height: 200px;" alt="Capa">
                        </div>
                    <?php endif; ?>

                    <div class="upload-area border-dashed rounded p-4 bg-light">
                        <i class="fas fa-sync fa-3x text-gray-400 mb-3"></i>
                        <h5>Alterar imagem de fundo</h5>
                        <p class="text-muted mb-3 small">Selecione uma nova imagem se desejar substituir a atual.</p>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4 border-left-info">
                <div class="card-header py-3 bg-white">
                    <h6 class="m-0 font-weight-bold text-info"><i class="fas fa-save mr-2"></i><?= __('Ações') ?></h6>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <label class="small font-weight-bold text-uppercase d-block">Cadastrado em:</label>
                        <span class="text-dark small"><?= $video->created->format('d/m/Y H:i') ?></span>
                    </div>
                    <div class="mb-0">
                        <label class="small font-weight-bold text-uppercase d-block">Última atualização:</label>
                        <span class="text-dark small"><?= $video->modified->format('d/m/Y H:i') ?></span>
                    </div>
                </div>
                <div class="card-footer bg-light border-top-0 py-3">
                    <button type="submit" class="btn btn-primary btn-icon-split btn-block shadow-sm">
                        ...
                        <span class="text font-weight-bold w-100"><?= __('Atualizar Vídeo') ?></span>
                    </button>
