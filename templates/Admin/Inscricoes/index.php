                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $inscrico->hasValue('aluno') ? '<span class="badge bg-info text-white">' . $this->Html->link($inscrico->aluno->nome, ['controller' => 'Alunos', 'action' => 'view', $inscrico->aluno->id], ['class' => 'text-white', 'style' => 'text-decoration: none;']) . '</span>' : '<span class="badge bg-secondary text-white">' . __('Sem Aluno') . '</span>' ?></td>
                            <td><?= $inscrico->hasValue('atividade') ? '<span class="badge bg-warning text-dark">' . $this->Html->link($inscrico->atividade->titulo, ['controller' => 'Atividades', 'action' => 'view', $inscrico->atividade->id], ['class' => 'text-dark', 'style' => 'text-decoration: none;']) . '</span>' : '<span class="badge bg-secondary text-white">' . __('Sem Atividade') . '</span>' ?></td>
