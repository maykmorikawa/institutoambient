        ...
        <div class="row">
            ...
            <div class="col-lg-8 mb-1-9 mb-lg-0 wow fadeIn" data-wow-delay="200ms">
                <div>
                    ...
                    <p class="mb-4">
                        Se você busca uma carreira com **propósito e impacto social real**, o Instituto Ambient é o lugar certo. Valorizamos a inovação, o trabalho articulado em rede e a proatividade. Nossos colaboradores são agentes de mudança, essenciais na construção de um futuro mais justo e sustentável para as famílias em situação de vulnerabilidade que atendemos.
                    </p>
                    <p class="mb-1-9">
            ...
            <div class="col-lg-4 wow fadeIn" data-wow-delay="400ms">
                <div class="bg-light p-4 p-xl-5" id="vagas-form">
                    <div class="title mb-1-9 text-start">
                        <h3 class="h4 text-primary">Banco de Talentos</h3>
                    </div>
                    <p class="mb-3">
                        Não encontrou uma vaga aberta? Mantenha seus dados em nosso banco de talentos.
                    </p>
                    ...
                    <p class="mt-4 small text-center">
                        *Os dados de contato são fictícios e devem ser substituídos pelos reais do Instituto.
                    </p>
                </div>
            </div>
        </div>
