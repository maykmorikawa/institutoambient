...
<section>
    <div class="container">
        <div class="text-center mb-2-9 mb-lg-6 wow fadeIn" data-wow-delay="100ms">
            ...
            <h2 class="mb-0 h1">Projetos e Ações</h2>
        </div>
        <div class="row mt-n1-9">
                ...
                <?php foreach ($posts as $post): ?>
                    <div class="col-md-6 col-lg-4 mt-1-9">
                        <article class="card card-style3 border-0 h-100">
                            ...
                            <div class="card-body p-xl-1-9 p-4 d-flex flex-column">
                                <h3 class="h5 mb-3">
                                    <a
                                        href="<?= $this->Url->build(h($post->excerpt)) ?>">
                                        <?= h($post->title) ?>
                                    </a>
                                </h3>
            ...
            <?php else: ?>
                <div class="col-12">
                    <p class="text-center">Nenhuma Inscrição disponível no momento.</p>
                </div>
            <?php endif; ?>
        </div>
