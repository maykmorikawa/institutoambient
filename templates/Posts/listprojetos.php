            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <ul class="ps-0">
                        ...
                        <li><a href="#">Projetos do Instituto</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<section>
    <div class="container">
        <div class="text-center mb-2-9 mb-lg-6 wow fadeIn" data-wow-delay="100ms">
            ...
            <h2 class="mb-0 h1">Mural de Projetos e Ações</h2>
        </div>
        <div class="row mt-n1-9">
                        ...
                        <article class="card card-style3 border-0 h-100">
                            <div class="card-img position-relative">
                                ...
                                <?php if ($featuredImage): ?>
                                    <img src="<?= $this->Url->build('/img/uploads/' . $featuredImage->filename) ?>" alt="<?= h($post->title) ?>">
                                <?php else: ?>
            ...
            <?php else: ?>
                <div class="col-12">
                    <p class="text-center">Nenhum projeto postado no momento.</p>
                </div>
            <?php endif; ?>
        </div>
        ...
        <style>
            ...
            .page-link { color: #51b54a; }
            .page-link:hover { color: #fff; background-color: #51b54a; border-color: #51b54a; }
