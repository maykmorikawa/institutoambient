...
/**
 * Configure the department element
 * Filters: Trim
 * Validators: Required
 */
$property = new Quform_Element('property', 'Property');
$property->addFilter('trim');
$property->addValidator('required');
$form->addElement($property);
